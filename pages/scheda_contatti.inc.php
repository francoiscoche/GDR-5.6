<div class="pagina_scheda_diario">
    ...
    <div class="page_title">
        <h2><?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['menu']['contact']); ?></h2>
    </div>
        ...
        <div class="panels_box">
            ...
            switch (gdrcd_filter_get($_POST['op'])) {
                case 'view': //Lettura pagina
                    include('scheda/contatti/view.inc.php');
                    break;

                case 'edit': //Form modifica pagina
                    include('scheda/contatti/edit.inc.php');
                    break;

                case 'new': // Form nuova pagina
                    include('scheda/contatti/new.inc.php');
                    break;

                case 'save_edit': // Salvataggio modifiche
                case 'delete': // Eliminazione
                case 'save_new': //Inserimento nuova pagina
                    include('scheda/contatti/save.inc.php');
                    break;

                default: //Lista pagine
                    include('scheda/contatti/index.inc.php');
                    break;
            } ?>
